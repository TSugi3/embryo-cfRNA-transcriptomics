...
Figure 1A and Figure 2A are schematic workflow panels prepared separately and
are not included in this repository. The PowerPoint assembly helpers will use
local `Figure1A_Workflow_HighRes.png` and `Figure2A_from_source_PPT.png` files
from `CFRNA_FIGURE_DIR` if supplied; otherwise they insert a placeholder for
those schematic panels.
