...
Some generated panel filenames retain historical prefixes for compatibility with the original analysis outputs. Final Source Data sheet names are normalized using `inventory/source_data_sheet_mapping.csv`. Extended Data figure scripts were similarly reorganized into single-page final display items; see `inventory/final_figure_mapping.csv`.
