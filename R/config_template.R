...
paths <- list(
  human_analysis_dir = get_env_or_stop("CFRNA_HUMAN_ANALYSIS_DIR"),
  human_figure_script_dir = get_env_or_stop("CFRNA_HUMAN_FIGURE_SCRIPT_DIR"),
  mouse_analysis_dir = get_env_or_stop("CFRNA_MOUSE_ANALYSIS_DIR"),
  project_root = get_env_or_stop("CFRNA_PROJECT_ROOT"),
  figure_dir = get_env_or_stop("CFRNA_FIGURE_DIR"),
  source_data_dir = get_env_or_stop("CFRNA_SOURCE_DATA_DIR"),
  source_data_workbook = get_env_or_stop("CFRNA_SOURCE_DATA_WORKBOOK"),
  log_dir = get_env_or_stop("CFRNA_LOG_DIR")
)
