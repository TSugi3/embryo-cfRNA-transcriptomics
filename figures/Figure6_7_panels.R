# Figure6_7_panels.R
# Shared generator for final Figure 6 panels and the final Figure 7 chord panel.
...
this_file <- if (length(file_arg) > 0) sub("^--file=", "", file_arg[1]) else "Figure6_7_panels.R"
