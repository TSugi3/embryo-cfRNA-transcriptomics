...
Figures 3/4 and 6/7 reuse upstream panel outputs. The final-numbered wrapper scripts are included so that the public file list follows the final manuscript numbering, while the shared panel generators preserve compatibility with the source-data mapping and original panel-output filenames.
