...
def main() -> None:
    ...
    add_picture(slide, "Figure3B_GO_BP_UpregulatedOnly.png", 0.208, 1.545, 7.083, 2.95)
    add_picture(slide, "Figure3C_GO_BP_DownregulatedOnly.png", 0.208, 4.985, 7.083, 2.95)
