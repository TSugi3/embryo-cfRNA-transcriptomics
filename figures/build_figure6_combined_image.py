...
def main() -> None:
    ...
    draw.text((0, 0), "Figure 6", fill="black", font=font)

    paste_fit(canvas, "Figure6A_CQ_GSEA_dotplot.png", 0.05, 0.30, 3.50, 2.78)
    paste_fit(canvas, "Figure6B_CQ_WE_gene_boxplot.png", 3.58, 0.30, 3.37, 1.96)
    paste_fit(canvas, "Figure6C_CQ_SM_release_barplot.png", 0.20, 3.48, 3.27, 1.68)
    paste_fit(canvas, "Figure6D_CB_GSEA_dotplot.png", 3.58, 2.85, 3.50, 2.78)

    rgb = canvas.convert("RGB")
    rgb.save(FIG_DIR / "Figure6_MouseValidation_Combined.png", dpi=(DPI, DPI))
    rgb.save(FIG_DIR / "Figure6_MouseValidation_Combined.tiff", compression="tiff_lzw", dpi=(DPI, DPI))
    print(FIG_DIR / "Figure6_MouseValidation_Combined.png")
